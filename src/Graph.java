...
public class Graph
{
    ...
    public static boolean processRequest(Graph g)
    {
        try
        {
            ...
            infotofile.add(counter + " " + verticies + " " + g.vertexMap.size() + " " + edges + " " + opcount_v + " " + opcount_e + " " + opcount_pql);
            ...
            System.out.println("Priority Queue operations: " + opcount_pql);
    ...
    public static void setGraph(){
        ...
        for(counter = 0; counter < numFiles; counter++){
            ...
            try{
                ...
                fw.write("graph PotentialVertexes VertexMapSize Edges VertexOperations EdgeOperations PQOperations\n");

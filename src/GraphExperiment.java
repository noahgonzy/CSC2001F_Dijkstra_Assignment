...
public class GraphExperiment
{
     ...
     * It also resets the edge process, vertex process, and priority queue log counter to 0.
     */
    public void dijkstra( String startName )
    {
        //setting operation counter to 0
        opcount = 0;
        ...
        {
            //Incremeting operation counter due to pq comparison made
            ...
            for( Edge e : v.adj )
            {
                ...
                //operation counter incremented due to another comparioson made
                opcount++;
                ...
                if( w.dist > v.dist + cvw )
                {
                    ...
                    //operation counter implemented when adding to the priority queue
                    opcount += (int)(Math.log(pq.size()) / Math.log(2));
                }
            }
        }
    ...
    public static boolean processRequest(GraphExperiment g)
    {
        try
        {
            ...
            //adding the information to be written to a text file for analysis later
            //the format for the output is: 
            //graph maxvertexespossible vertexesfound edges vertexoperations edgeoperations pqoperations pqloperations
            infotofile.add(counter + " " + verticies + " " + g.vertexMap.size() + " " + edges + " " + opcount);
     ...
     * 
     * Before doing the aforementioned things, it creates the infoFile to write information 
     * for analysys later
     */
    public static void main( String [ ] args )
    {
        try{
            //reads in info file and gets the number of files in data folder
    ...
    public static void setGraph(){
        ...
        for(counter = 0; counter < numFiles; counter++){
            ...
            try{
                //Program writes the information generated by the algorithm to a text file
                //for later analysis
                FileWriter fw = new FileWriter("data/Djikstraout.txt");
                fw.write("graph PotentialVertexes VertexMapSize Edges Operations\n");
